...
/* Define to 1 if you have the <udt/udt.h> header file. */
#define HAVE_UDT_UDT_H 1
...
#define PACKAGE_BUGREPORT "vkonoplev@acm.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "udtgate"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "udtgate 1.3-fix5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "udtgate"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.3-fix5"
